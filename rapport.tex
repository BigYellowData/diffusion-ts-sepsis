...
l'indice de Youden sur la validation. ECE et Util. disponibles uniquement pour notre méthode.
$\uparrow$ meilleur, $\downarrow$ meilleur. $\dagger$ : signatures sur 8 signes vitaux,
depth=2, semi-supervisé (10\% labels) — conditions différentes de Morrill et al.}
...
\textbf{Diffusion-TS + Aug + MC Dropout (ours)} &
    \textbf{0.8679} & \textbf{0.1363} & 0.1139 & \textbf{$-$0.052} & \textbf{0.006} \\
\bottomrule
\end{tabular}}
\end{table}
