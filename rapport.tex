...
des prédictions incorrectes est 12.8$\times$ supérieure à celle des prédictions
...
\begin{enumerate}
    ...
    12.8$\times$ plus élevée sur les erreurs, ECE = 0.009.
    \item \textbf{La diffusion surpasse l'approche GAN sur cette tâche} : AUROC 0.868
    contre 0.836 pour TimeGAN (semi-supervisé) à protocole identique, et la qualité
    visuelle et statistique des trajectoires synthétiques (figures~\ref{fig:traj}
    et~\ref{fig:dist}) confirme que les samples reproduisent les distributions
    cliniques attendues.
\end{enumerate}
