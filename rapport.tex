...
\begin{table}[H]
\centering
\caption{Résultats sur le jeu de test. Seuil calibré par l'indice de Youden sur la
validation pour toutes les méthodes. ECE disponible uniquement pour notre méthode.
$\uparrow$ meilleur, $\downarrow$ meilleur.}
...
BiLSTM (labellé seul.)       & Supervisé classique      & 0.8406 & 0.1113 & 0.1326 & --- \\
Transformer (sans augm.)     & Diffusion sans semi-sup. & 0.7881 & 0.0743 & 0.0919 & --- \\
\rowcolor{bestrow}
\textbf{Diffusion-TS + Aug + MCD} & \textbf{Notre méthode} &
    \textbf{0.8684} & \textbf{0.1356} & 0.1228 & \textbf{0.006} \\
\bottomrule
\end{tabular}
\end{table}
